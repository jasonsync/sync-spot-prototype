...
$config = [
  'test_screen'=>true, // if true, captive portal redirects to the API Test screen (guest/s/default/tests/index.php)
  'dev_mode'=>true, // if false, then all debugging is suppressed
  'unifi-api'=> [
    'controller' => [
  ...
  'sync'=>[
    'unifi-helper' => [
    'debug'=> true// verbose calling of API. Also displays PHP session / GET parameters
    ]
  ]
];
